...
let virtual-env = "D:\work\python project\design pattern\state pattern"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\work\python project\design pattern\state pattern\Scripts\deactivate.nu"
